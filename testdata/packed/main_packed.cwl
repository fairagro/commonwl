            ...
            "inputs": [
                {
                    ...
                    "default": {
                        "class": "File",
                        "location": "file:///mnt/commonwl/testdata/packed/data/population.csv"
                    },
                    "inputBinding": {
                        "prefix": "--population"
                    }
                },
                {
                    ...
                    "default": {
                        "class": "File",
                        "location": "file:///mnt/commonwl/testdata/packed/data/speakers_revised.csv"
                    },
                    "inputBinding": {
                        "prefix": "--speakers"
                    }
            ...
            "inputs": [
                {
                    ...
                    "default": {
                        "class": "File",
                        "location": "file:///mnt/commonwl/testdata/packed/results.csv"
                    },
                    "inputBinding": {
                        "prefix": "--results"
                    }
